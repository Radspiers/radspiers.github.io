        ...
        <div class="jam-card" style="aspect-ratio: 1 / 1; width: calc(18% - 15px); min-width: 200px; max-width: 240px; align-items: center; justify-content: center; text-align: center; padding: 20px; box-sizing: border-box;">
            ...
            <div style="color: #28a745; margin-bottom: 12px; width: 36px; height: 36px;">
                <svg viewBox="0 0 512 512" width="36" height="36" fill="currentColor">
                    ...
                    <path d="M160 140v140c0 53 43 96 96 96s96-43 96-96V140h-40v140c0 31-25 56-56 56s-56-25-56-56V140h-40zm96 180c-13.2 0-24-10.8-24-24v-60h48v60c0 13.2-10.8 24-24 24z"/>
                    <path d="M256 360l-30-50h60z"/>
                </svg>
            </div>
